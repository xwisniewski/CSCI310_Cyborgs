...
public class PromptEntity {
    ...
    public PromptEntity(String id, String title, String promptText, String description, String llmTag, String experience, Long publishDate, String userId, Boolean isDraft) {
        this.id = id;
        this.title = title;
