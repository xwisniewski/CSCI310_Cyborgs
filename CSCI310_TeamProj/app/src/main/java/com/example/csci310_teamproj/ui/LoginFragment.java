...
public class LoginFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        // Detect if Espresso test environment is running
        ...
        boolean finalIsTestEnvironment = isTestEnvironment;
            ...
            auth.signInWithEmailAndPassword(email, password)
                    .addOnCompleteListener(task -> {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            // ---------------------------
                            // OPTION B: Force intent when running tests
                            // ---------------------------
                            if (finalIsTestEnvironment) {
                            ...
                            // Normal app navigation inside AuthActivity
